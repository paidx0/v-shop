<template>
  <div class="content-container" direction="vertical">
    <el-container class="content-row">
      ...
      <div class="info">秒杀商品交易额：{{ this.data.speTra }}</div>
      <div class="info">普通商品交易额：{{ this.data.norTra }}</div>
      <div class="info">累计用户数：{{ this.data.userCount }}</div>
      <div class="info">分销店长数：{{ this.data.managerCount }}</div>
    </el-container>
    ...
    <el-container class="content-row">
      <el-radio-group @change="changeType" v-model="type">
        ...
        <el-radio-button label="新用户增长数"></el-radio-button>
      </el-radio-group>
    </el-container>

    <charts id="charts" :xData="xData" :data="chartsData"></charts>
    <div class="realTime">
      <div class="info">更新时间：{{ this.data.time }}</div>
      <el-container class="content-row">
        <div class="block">
