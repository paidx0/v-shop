  ...
  <div class="content-container" direction="vertical">
    ...
    <div>
      ...
      >
        ...
        <el-table-column label="链接" width="200" prop="source"></el-table-column>
      </el-table>
    </div>
...
export default {
  ...
  methods: {
    ...
    // 导出订单
    exportData() {
      exportJson.exportJson('订单.json', JSON.stringify(this.orderList));
    },
    // 导出选中的发货单
    exportDispatchGoods() {
      exportJson.exportJson('发货单.json', JSON.stringify(this.multipleSelection));
    },
    // 多选框
