  ...
  <div class="content-container" direction="vertical">
    ...
    <div>
      <el-table :data="orderList" tooltip-effect="dark" style="width: 100%">
        <el-table-column label="类型" width="120" prop="state"></el-table-column>
        <el-table-column label="商品名称" width="120" prop="name"></el-table-column>
        <el-table-column label="订单号" width="150" prop="id"></el-table-column>
        <el-table-column label="店长信息" width="200" prop="manager"></el-table-column>
        <el-table-column label="件数" width="80" prop="count"></el-table-column>
        <el-table-column label="价格" width="100" prop="price"></el-table-column>
        <el-table-column label="佣金" width="100" prop="coin"></el-table-column>
        <el-table-column label="支付时间" width="200" prop="payTime"></el-table-column>
        <el-table-column label="发货时间" width="200" prop="sendTime"></el-table-column>
      </el-table>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    exportData() {
      // 导出订单
      exportJson.exportJson('店长订单.json', JSON.stringify(this.orderList));
    }
  }
}
</script>